...
class Ui_ButtonForm(object):
    def setupUi(self, ButtonForm):
        ...
        sizePolicy5.setHeightForWidth(self.pushButton1.sizePolicy().hasHeightForWidth())
        self.pushButton1.setSizePolicy(sizePolicy5)
        self.pushButton1.setStyleSheet(u"padding: 2px 6px;")

        self.formLayout.setWidget(11, QFormLayout.ItemRole.FieldRole, self.pushButton1)

        self.pushButton2 = QPushButton(ButtonForm)
        self.pushButton2.setObjectName(u"pushButton2")
        sizePolicy5.setHeightForWidth(self.pushButton2.sizePolicy().hasHeightForWidth())
        self.pushButton2.setSizePolicy(sizePolicy5)
        self.pushButton2.setStyleSheet(u"padding: 2px 6px;")

        self.formLayout.setWidget(11, QFormLayout.ItemRole.FieldRole, self.pushButton2)
    ...
    def retranslateUi(self, ButtonForm):
        ...
        self.label_1.setText(QCoreApplication.translate("ButtonForm", u"Global state", None))
        self.pushButton.setText(QCoreApplication.translate("ButtonForm", u"\n"
"    Exempt\n"
"    ", None))
        self.pushButton1.setText(QCoreApplication.translate("ButtonForm", u"v", None))
        self.pushButton2.setText(QCoreApplication.translate("ButtonForm", u"x", None))
